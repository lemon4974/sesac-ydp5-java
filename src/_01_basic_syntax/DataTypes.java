...
public class DataTypes {
    public static void main(String[] args) {
        ...
        short z = 32767;
        byte b = 127;
        // 타입에 따라 저장될 수 있는 숫자의 범위가 다르다

        // 실수형 변수
        float a = 3.14f; // float 타입은 뒤에 F, f 붙여야 함
        double c = 2.71828; // double은 float 의 두 배를 저장할 수 있어 더블.

        // 문자형 변수 선언
        // - 유니코드를 저장할 수 있는 자료형
        // - 유니코드란? 세계 각국의 문자를 0~65535 숫자로 매핑한 국제 표준 규약

        char ch = 'A'; // 문자 하나를 표현할 때 사용. A는 65 매핑
        char ch2 = '가'; // 44032 매핑
        ...
        //자바는 string이 참조형임을 기억하자. 기본형 처럼 쓰이긴 함

        // String 참조형 변수
        // - Java 에서 String 타입은 특별함. 참조형인데 기본형처럼 사용함
        // - 기본 자료형은 == 연산자를 통해 비교하지만, Stirng 객체간 비교는 .equals() 메소드 사용
