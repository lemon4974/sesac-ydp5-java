...
public class ArrayEx {
    public static void main(String[] args) {
        ...
        // ex. 타입[] 변수 = null;
        // => 배열 변수가 null 값을 가진 상태에서 인덱싱 한다면 NullPointerException 발생
        String[] temp = null;
        ...
        System.out.println("참조값: " + intArray); // 참조값
        ...
        System.out.println("참조값: " + charArray); // 참조값
        System.out.println();
...
//        System.out.println(doubleArray[doubleArray.length]); // ArrayIndexOutOfBoundsException
        ...
        // 0, 1: 문자열 리터럴 저정. 문자열 리터럴; Java 컴파일러가 문자열 풀(string pool) 공유된 영역에 저장
        ...
        // - Object dest: 새로운 배열
        // - int destPos: 새로운 배열 붙여놓기 시작 인덱스
        // - int length: 복살할 원소 개수
